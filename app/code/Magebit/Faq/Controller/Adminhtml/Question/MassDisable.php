...
class MassDisable extends Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $question) {
            $this->questionManagement->disableQuestion((int)$question->getId());
        }
        $this->messageManager->addSuccessMessage(__('A total of %count record(s) have been disabled.', ['count' => $collection->getSize()]));
